      ...
      <>
          ...
          <Card className="col-span-12 lg:col-span-4">
            ...
            <div className="grid gap-2">
              ...
              <QuickAction to="/reception" icon={<PlayCircle className="size-4" />} label="Open today's queue" />
              <QuickAction to="/reception/appointments" icon={<CalendarDays className="size-4" />} label="Manage appointments" />
              <QuickAction to="/admin/settings/access" icon={<UserCog className="size-4" />} label="Manage staff" />
            </div>
          </Card>
      </>
    </div>
