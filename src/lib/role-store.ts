...
export const roleMeta: Record<Role, {
  ...
  allopathy: {
    ...
    home: "/doctor",
    allowedPrefixes: ["/doctor", "/consultation", "/prescription"],
    initials: "AL",
    accent: "text-primary",
  },
  homeopathy: {
    ...
    home: "/admin",
    allowedPrefixes: ["/admin", "/homeopathy", "/reception", "/consultation", "/prescription"],
    initials: "HM",
  ...
  admin: {
    ...
    home: "/admin",
    allowedPrefixes: ["/admin", "/staff", "/settings", "/reception", "/doctor", "/homeopathy", "/consultation", "/prescription"],
    initials: "OW",
